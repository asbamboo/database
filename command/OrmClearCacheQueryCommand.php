...
/**
 * 同 doctrine orm:clear-cache:query
 *
 * @author 李春寅 <licy2013@aliyun.com>
 * @since 2018年11月22日
 */
class OrmClearCacheQueryCommand extends CommandAbstract
{
    /**
     * Construct
     */
    ...
    {
        return 'Clear all query cache of the various cache drivers';
    }
    ...
    public function help() : string
    {
        ...
        return <<<HELP
    该命令功能与doctrine/orm中的orm:clear-cache:query相同

    The asbamboo:database:clear-cache-query command is meant to clear the query cache of associated Entity Manager.
    ...
    asbamboo:database:clear-cache-query

    Alternatively, if you want to flush the cache provider using this command:

    asbamboo:database:clear-cache-query --flush
...
HELP;
    ...
    {
        return 'asbamboo:database:clear-cache-query';
    }
