...
interface ConnectionInterface extends Connection
{
     ...
     *
     * @param array $params
     * @param string|array $metadata_config
     * @param int $metadata_type 取值范围是常量 ConnectionInterface::MATADATA_*
     * @param bool $is_dev
     * @return ConnectionInterface
     */
    public static function create(array $params, /*string|array*/ $metadata_config, string $metadata_type, bool $is_dev): ConnectionInterface;
}